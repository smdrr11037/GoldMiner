...
GameAPP::GameAPP(){
    ...
    QObject::connect(m_model, &Model::stateChanged, m_viewModel, &ViewModel::stateChanged);
    QObject::connect(m_model, &Model::pageChanged, m_viewModel, &ViewModel::pageChanged);
    // // 需要转换页面，传递参数 GameState
    ...
    // // 玩家按下键盘，伸长钩子
    // QObject::connect(m_window, &MainWindow::pressKey, m_viewModel, &ViewModel::handelPressKey);
}
GameAPP::~GameAPP(){
}
void GameAPP::run(){
